...
### 2017-03-20
- Improvements
  - We Have added password for both Admin Login (Login Id: 'admin' and Password: '1234') and Counter Incharge Login (Login Id: 'admin' and Password: '1234').
  - Scope of barcode is improved to admin entry. 
  - All the modules are integrated.
### 2017-03-03
- Features
  - We add a admin login such that he can now add, edit or delete products according to time and availability.
  - A basic Barcode Scanner(using quaggaJS) is being Implemented on Counter login so that product id's can be scanned using their barcodes.
 
- Fixes
  - We make changes in the counter login such that a bill receipt can be generated for all the purchased products.

### 2017-02-21
- Initialization
  - Project Is Being initialized for developing a supermarket Billing System.
  - Starts with one model where the counter incharge makes entries for a product entered and it gets saved in the database.
